...
class FriendsStorage{
    ...
    init(){
        friends = [
            .init(name: "Borat", surname: "Sagdiyev", imageUser: [
            ...
            .init(name: "Ali", surname: "G", imageUser: [
            ...
            .init(name: "Aladdin", surname: "Dictator", imageUser: [
            ...
            .init(name: "Big", surname: "Boss", imageUser: [
                .init(name: "bigBoss-0", like: 0)
            ]),
            .init(name: "Bruno", surname: "Gehard", imageUser: [
            ...
            .init(name: "Herceg", surname: "Five", imageUser: [
